...
+ 可以我的  [LeetBook](https://leetcode-cn.com/leetbook/read/learning-algorithms-with-leetcode/xsq0b7/) 收看二分查找的知识点讲解，免费；
...
| 34   | [在排序数组中查找元素的第一个和最后一个位置](https://leetcode-cn.com/problems/find-first-and-last-position-of-element-in-sorted-array/) | [视频讲解](https://www.bilibili.com/video/av83911694?p=3)、[文字题解](https://leetcode-cn.com/problems/find-first-and-last-position-of-element-in-sorted-array/solution/si-lu-hen-jian-dan-xi-jie-fei-mo-gui-de-er-fen-cha/) |
...
+ 第 34 题：二分查找找边界问题、[CSDN](https://blog.csdn.net/lw_power/article/details/104066739)；
+ 第 4 题：二分查找里最难的问题，重点在于：① 为什么是在短数组里找边界；② 边界条件的判断。
